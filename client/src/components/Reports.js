...
const Reports = () => {
  ...
  const handleProjectChange = async (projectId) => {
    ...
    // Reset participant data when project changes
    setParticipantData({
      participant_type: '',
      male_batstateu_participants: '',
      female_batstateu_participants: '',
        ...
        <Row className="justify-content-center">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
              <div>
                ...
                <p className="text-muted mb-0">Generate reports for completed projects</p>
              </div>
              <Button variant="outline-secondary" as={Link} to="/dashboard">
                      ...
                      <div className="mb-3 p-3 border border-warning rounded" style={{ backgroundColor: '#fff3cd' }}>
                        <div className="d-flex align-items-center justify-content-between mb-2">
                          <div className="d-flex align-items-center">
                            ...
                            <strong className="text-warning">Section to be filled out:</strong>
                          </div>
                          {existingReport && (

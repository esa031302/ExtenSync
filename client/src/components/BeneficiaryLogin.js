    ...
    <div className="beneficiary-login-container">
      <Container>
        <Row className="justify-content-center">
          <Col md={6} lg={5} xl={4}>
            <Card className="shadow border-0 beneficiary-login-card">
              <Card.Body className="p-5">
                <div className="text-center mb-4">
                  <img src="/extensynclogo.png" alt="ExtenSync" className="brand-logo" />
                  <h4 className="mt-3 mb-2 text-primary">Beneficiary Login</h4>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className="d-flex justify-content-center">
                    <Button
                      variant="primary"
                      type="submit"
                      className="beneficiary-login-button d-inline-flex align-items-center justify-content-center"
                      disabled={loading}
                    >
                      {loading ? (
                        <>
                ...
                <div className="text-center mt-4">
                  <p className="mb-0">
                    ...
                    <Link to="/beneficiary/register" className="text-decoration-none fw-semibold">
                      Register here
                    </Link>
                  </p>
                </div>
